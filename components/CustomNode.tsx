...
export default function CustomNode({ data }: Props) {
  ...
  const containerClass = isCurrent
    ? 'w-56 rounded-lg border p-3 shadow-md border-blue-500 ring-2 ring-blue-200 bg-blue-50'
    : 'w-56 rounded-lg border p-3 shadow-md border-zinc-200 bg-white dark:border-zinc-700 dark:bg-[#111]';
